...
<main role="main">
        ...
        <div class="col-12 col-md-10 col-lg-8">
            <form class="card card-sm" method="POST">
                <div class="card-body row no-gutters align-items-center">
                    ...
                    <!--end of col-->
                    <div class="col-auto">
                        <button class="btn btn-lg btn-light" name="submit" type="submit"><i class="fa fa-search"></i>Search
                        </button>
                    </div>
                    <!--end of col-->
                </div>
    ...
    <div class="container d-flex justify-content-centre">
        ...
        <h2>What's today's adventure?</h2>
        <div class="container d-flex justify-content-centre">
            <p><a class="btn btn-warning" href="createposts.php" role="button">New Post &raquo;</a></p>
        </div>
    </div>
