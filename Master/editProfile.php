...
<div id="editDetails">
    <form action="" enctype="multipart/form-data" method="post" id="editDetailsForm">
        ...
        <input name="country" class="formInput" id="Country" type="text"
        ...
        <input name="favourite" class="formInput" id="Favourite" type="text"
               value="<?php echo htmlspecialchars($favourite); ?>">
