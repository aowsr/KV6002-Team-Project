    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="first-slide" src="Media/beach-benches-bridge-2091018.jpg" style='max-width: 100%; max-height: 100%;' alt="First slide">
                <div class="container">
...
<div class="container marketing">
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto img-thumbnail" src="Media/adventure-backpacker-blue-sky-1271619.jpg " alt="Generic placeholder image">
        </div>
    </div>
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5 order-md-1">
            <img class="featurette-image img-fluid mx-auto img-thumbnail" src="Media/adventure-casual-cheerful-541518.jpg" alt="Generic placeholder image">
        </div>
    </div>
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto img-thumbnail" src="Media/activity-adventure-blur-297642.jpg " alt="Generic placeholder image">
        </div>
    </div>
